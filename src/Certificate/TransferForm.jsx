...
function TransferForm() {
  ...
  const [formData, setFormData] = useState({
    ...
    birthPlace: student?.dob_place || '',
    taluka: student?.address.taluka || '',
    district: student?.address.district || '',
    nationality: student?.nationality || '',
    caste: student?.caste || '',
    admissionDate: student?.admDate || '',
  ...
  return (
    <div className='text-white bg-[#412249] min-h-screen font-[roboto]'>
      <div className='pt-20'>
        <h2 className='text-3xl font-semibold text-center'>Transfer Certificate Details</h2>
      ...
      <div className='mt-8 md:mt-16 container mx-auto'>
        <div className='grid grid-cols-1 md:grid-cols-2 gap-12 max-w-lg lg:max-w-6xl mx-auto'>
          {Object.keys(formData).map((key) => (
            key !== 'subjects' && key !== 'promotion' && key !== 'govtCategory' && key !== 'extracurricular' && (
          ...
          {formData.subjects.map((subject, index) => (
            <div key={index} className='px-2'>
              <label className='text-white mb-2'>{`Subject ${index + 1}:`}</label>
              <input
                type='text'
          ...
          <div className='px-2'>
            <label className='text-white mb-2'>Qualified for promotion to the higher class:</label>
          ...
          <div className='px-2'>
            <label className='text-white mb-2'>Whether school is under Govt./ Minority / Independent Category:</label>
            <div className='flex items-center'>
              <label className='mr-2'>YES</label>
              <input
                type='radio'
          ...
          <div className='px-2'>
            <label className='text-white mb-2'>Games played or extra curricular activities:</label>
            <div className='flex items-center'>
              <label className='mr-2'>YES</label>
              <input
                type='radio'
